...
/**
 * Web3Auth Wallet Mode Application
 *
 * This page uses Web3Auth embedded wallet with Provider pattern
 * Following the official Web3Auth documentation:
 * https://docs.metamask.io/embedded-wallets/sdk/vue/
 *
 * Features:
 * 1. Web3Auth Provider wrapper
 * 2. Social login support (Google, Twitter, etc.)
 * 3. DDCNFT workflow testing
 * 4. Membership workflow testing
 */
...
import web3AuthContextConfig from '../web3authContext.ts';
    ...
    <WagmiProvider>
      <div class="app-container">
        ...
        <header class="app-header">
          ...
          <div class="wallet-mode-badge web3auth-mode">🌐 Web3Auth Mode</div>
          <p class="subtitle">Social Login with Embedded Wallets</p>
        ...
        <main class="main-content">
            ...
            <div class="info-grid">
              <div class="info-card">
                ...
                <ol>
                  ...
                  <li>
                    ...
                    <strong>(Only once before deploying any NFT contract)</strong>
                  </li>
              ...
              <div class="info-card">
                ...
                <ol>
                  ...
                  <li>
                    Deploy Factory Contract
                    <strong>(Only once before deploying any Membership contract)</strong>
                  </li>
                  <li>
                    Deploy Membership Contract (Every time you need a new Membership contract)
                  </li>
          ...
          <section class="section warning-section">
            ...
            <ul>
              <li>
                <strong>Test Network</strong>: Recommend testing on test networks (e.g. Sepolia,
                Goerli)
              </li>
              <li>
                <strong>Private Key Security</strong>: Never expose private keys in production or
                public settings
              </li>
              <li>
                <strong>Transaction Confirmation</strong>: On-chain operations require waiting for
                block confirmation, please be patient
              </li>
              <li>
                <strong>Web3Auth Login</strong>: Supports Google, Twitter, Discord, GitHub and more
                social logins
              </li>
            </ul>
          </section>
        ...
        <footer class="app-footer">
          ...
          <p>Powered by DDC Market SDK & Web3Auth</p>
        </footer>
      </div>
    </WagmiProvider>
  </Web3AuthProvider>
